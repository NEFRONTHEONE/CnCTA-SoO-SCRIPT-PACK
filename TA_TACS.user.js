				...
				members : {
					...
					initialize : function () {
						try {
                            ...
                            this._armyBarContainer.getMainContainer().getChildren()[0].setMarginTop(40);
                            this._armyBarContainer.getMainContainer().getChildren()[3].setVisibility("hidden");
                            this._armyBarContainer.removeAt(1);
                            this._PlayArea.getChildren()[0].setMarginTop(-30);
                              }
